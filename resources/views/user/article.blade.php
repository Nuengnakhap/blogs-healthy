...
@section('main-content')
	<div class="super_container">
		<div class="home">
			<div class="home_background parallax-window" data-parallax="scroll" data-speed="0.8"><img class="home_background" src="{{asset($post->image_title)}}"></div>
								...
								<div class="tags_share d-flex flex-row align-items-center justify-content-start">
									<div class="post_tags">
										<ul>
											...
											@endphp
											@foreach(array_reverse($tag_selects) as $tag)
												<li class="post_tag"><a href="{{route('post', 'tag/'.$tag)}}">{{$tag}}</a></li>
											@endforeach
										</ul>
									</div>
								</div>

...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2018 at 02:51 AM
...
(1, 'admin', 'admins@admin.com', '$2y$10$jyaJFA5wGmkCLKci4A.jg.oMRXKZ0ulhEk38nz9uqLVUiZ38fsx0G', 'Admin', 1, '2018-11-01 08:00:00', '2018-11-01 08:00:00');
...
--
-- Table structure for table `comment_forums`
--
...
--
-- Indexes for table `comment_forums`
--
ALTER TABLE `comment_forums`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comment_forums_forum_id_foreign` (`forum_id`);
...
--
-- AUTO_INCREMENT for table `comment_forums`
--
ALTER TABLE `comment_forums`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `comment_forums`
--
ALTER TABLE `comment_forums`
  ADD CONSTRAINT `comment_forums_forum_id_foreign` FOREIGN KEY (`forum_id`) REFERENCES `forums` (`id`) ON DELETE CASCADE;
